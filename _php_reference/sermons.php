					...
					<div class="resource-list">
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/SS.png" alt="Sabbath School" class="resource-icon-img">
							</div>
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/BS.jpeg" alt="Bible Study" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/PY.jpg" alt="Prayer" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/AB.png" alt="Adventist Beliefs" class="resource-icon-img">
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<picture>
									...
									<img src="assets/MP.png" alt="Music Philosophy" class="resource-icon-img" loading="lazy" decoding="async">
								</picture>
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<picture>
									...
									<img src="assets/YA.jpg" alt="Young Adults" class="resource-icon-img" loading="lazy" decoding="async">
								</picture>
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<picture>
									...
									<img src="assets/AP.png" alt="Adventist Pioneer" class="resource-icon-img" loading="lazy" decoding="async">
								</picture>
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<picture>
									...
									<img src="assets/EGW.png" alt="EGW Writings" class="resource-icon-img" loading="lazy" decoding="async">
								</picture>
							</div>
							<div class="resource-content">
						...
						<div class="resource-item">
							<div class="resource-icon">
								<img src="assets/AA.jpeg" alt="Adventist Archives" class="resource-icon-img">
							</div>
							<div class="resource-content">
